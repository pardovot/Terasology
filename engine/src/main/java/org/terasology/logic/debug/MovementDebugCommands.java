...
public class MovementDebugCommands extends BaseComponentSystem {
    ...
    public static final String godmodeEnabled = "org.terasology.godmode";
    ...
    @Command(shortDescription = "Makes you immune to all damage(godmode)", runOnServer = true, requiredPermission = PermissionManager.CHEAT_PERMISSION)
    public String godmode(@Sender EntityRef client) {
        String value = System.getProperty(godmodeEnabled);
        if (value != "true" && value != "false") {
            System.setProperty(godmodeEnabled, "false");
        }
        value = System.getProperty(godmodeEnabled);
        if (value.equals("true")) {
            System.setProperty(godmodeEnabled, "false");
            return "Godmode has been toggled off";
        } else {
            System.setProperty(godmodeEnabled, "true");
            return "Godmode has been toggled on";
        }
    }
    ...
    @Command(shortDescription = "Show your Position/Location", requiredPermission = PermissionManager.CHEAT_PERMISSION)
    ...
    @Command(shortDescription = "Teleport all users to location", runOnServer = true, requiredPermission = PermissionManager.USER_MANAGEMENT_PERMISSION)
    ...
    public static String getGodmodeenabled() {
